...
<div class="card border-primary mb-3">
    <div class="card-header">
      ...
      <div class="card-body">
        {!! Form::open(['route' => 'emprendedor.actualizar', 'method' => 'POST','id' => 'FormEditEmprendedor', 'files' => true]) !!}
        {!! Form::hidden('id', $emprendedores->id , ['id' => 'id']) !!}
        {!! Form::hidden('carpeta', $emprendedores->carpeta , ['id' => 'carpeta']) !!}
        <div class="form-group row">
            ...
            <select class="form-control custom-select custom-select-sm" name="categoria" id="Categorias">
                ...
                @foreach($categorias as $categoria)
                    @if($categoria->id == $emprendedores->categoria_id)
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="sede" id="sede">
                          ...
                          @foreach($sedes as $sede)
		                    @if($sede->nombre == $emprendedores->sede)
		                    <option selected="selected" value="{{ $sede->nombre }}"> {{ $sede->nombre }} </option>
		                    @else
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Ingrese Nombre de Proyecto" value="{{ $emprendedores->nombre_proyecto }}">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Equipo</label>
                <div class="col-sm-10">
                    <textarea class="form-control" name="equipo" id="equipo" rows="6">{{ $emprendedores->equipo }}</textarea>
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Contacto</label>
                <div class="col-sm-10">
                    <textarea class="form-control" name="contacto" id="contacto" rows="6">{{ $emprendedores->contacto }}</textarea>
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Resumen</label>
                <div class="col-sm-10">
                    <textarea class="form-control" name="resumen" id="resumen" rows="6">{{ $emprendedores->resumen }}</textarea>
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Url Video</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="video" id="video" value="{{ $emprendedores->url_video }}">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    ...
                    <img src="{{ '/'.$emprendedores->imagen_grande }}" class="img-fluid" width="200" height="150">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    ...
                    <img src="{{ '/'.$emprendedores->imagen }}" class="img-fluid" width="200" height="150">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    ...
                    <img src="{{ '/'.$emprendedores->logo }}" class="img-fluid" width="200" height="150">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input class="form-check-input estados" value="1" type="checkbox" name="estado" id="Estado" @if($emprendedores->estado == 1) checked=checked @endif>
                    </div>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-12">
                    <button type="button" class="btn btn-primary btn-sm btn-block" id="EditarEmprendedor">Editar Emprendedor</button>
                </div>
            </div>
            {!! Form::close() !!}
      </div>
...
<script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#EditarEmprendedor').on('click', function(e) {
        e.preventDefault();
        ...
        var Video = $("#video").val();
           ...
           var form = $('#FormEditEmprendedor');
           var url = form.attr('action');
           var formData = new FormData($("#FormEditEmprendedor")[0]);
           ...
           $.ajax({
	          ...
	          success: function(respuesta) {
	             if (respuesta.message == 'success') {
	                swal("OK!", "Emprendedor Editado Correctamente!", "success")
	                .then((value) => {
                        $("#FormEditEmprendedor")[0].reset();
	                  location.reload();
	                });
              }
	         }
